...
# --------------------------------------------------
# Network config - NOW USING DOCKER SERVICE NAMES
# --------------------------------------------------
# The simulator is now a Docker service
SIMULATOR_HOST = "simulator"  # Docker service name
SIMULATOR_PORT = 5000
...
# --------------------------------------------------
print("[Sender] Waiting for simulator to be ready...")
time.sleep(5)  # Give simulator time to initialize
...
print(f"[Sender] Target: {SIMULATOR_HOST}:{SIMULATOR_PORT} (Containerized MATLAB Simulator)")
