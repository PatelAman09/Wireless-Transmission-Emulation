rf_channel_pkg MATLAB Python Package
...
Alternatively, download and install the Macintosh version of the MATLAB Runtime for R2025b 
...
2. Installing the rf_channel_pkg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
rf_channel_pkg. If you do not have write permissions, copy all its contents to a 
...
In the following directions, replace MR/R2025b by the directory on the target machine where MATLAB is installed, or MR by the directory where the MATLAB Runtime is installed.

If the environment variable DYLD_LIBRARY_PATH is undefined, set it to the following string:

MR/R2025b/runtime/maca64:MR/R2025b/sys/os/maca64:MR/R2025b/bin/maca64

If it is defined, set it to the following:

${DYLD_LIBRARY_PATH}:MR/R2025b/runtime/maca64:MR/R2025b/sys/os/maca64:MR/R2025b/bin/maca64

3. Using the rf_channel_pkg Package
...
The rf_channel_pkg package is on your Python path. To import it into a Python script or 
session, execute:
